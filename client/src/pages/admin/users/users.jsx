...
function AdminUsers() {
  ...
  return (
    <>
      <Card className="p-2">
        <AdminHeader crumbs={[{ title: "Usuarios" }]} />
        <Divider />
        <CardBody>
          <Table
            isHeaderSticky
          ...
          >
            <TableHeader>
              ...
              <TableColumn width={"15%"} key="collection">
                Sellos
              </TableColumn>
              <TableColumn width={"5%"} key="actions">
                Acciones
              </TableColumn>
              <TableColumn width={"10%"} key="lastLogin" allowsSorting>
                Último Acceso
              </TableColumn>
              <TableColumn width={"10%"} key="nameUpdateDate" allowsSorting>
                Cambio de Nombre
              </TableColumn>
              <TableColumn width={"10%"} key="teamUpdateDate" allowsSorting>
                Cambio de Equipo
              </TableColumn>
